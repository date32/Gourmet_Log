...
<div class="dis">
    ...
    <div class=" wi9 mcenter">
        <div class="mt10 tcenter">
            ...
            <form class="" method="POST" action="/shop/create/result" enctype="multipart/form-data">
                @csrf
                ...
                @if (!session()->has('form_data'))
                    ...
                    <div><input class="wi3" type="text" name="name_katakana" value="{{ old('name_katakana') }}">
                    </div>
                    ...
                    <div class="wi3 mcenter">
                        <div class="radio-container">
                            @foreach ($categories as $category)
                                <div class="mr10">
                                    <input id="{{$category->name}}" type="radio" name="category_name" value="{{ $category->name }}"
                    ...
                    <div><input class="wi3" type="tel" name="tel"  value="{{ old('tel') }}"></div>
                    ...
                    <div class="mb10"><input class="wi3" type="text" name="comment"  value="{{ old('comment') }}"></div>
                @endif
                    ...
                    <div class="dis mt10 ccenter">
                        ...
                        <div>
                            ...
                            @if (isset($formData['map_url']))
                                ...
                                <div><input class="wi3" type="text" name="map_url"
                                        placeholder="変更する時は入力してください。">
                                </div>
                            @else
